...
Phaser.Plugin.Juicy.ScreenFlash = function(game, color) {
  color = color || 'white';
  var bmd = game.add.bitmapData(Application.Game.world.width, Application.Game.world.height);
  bmd.ctx.fillStyle = color;
  bmd.ctx.fillRect(0,0, Application.Game.world.width, Application.Game.world.height);
