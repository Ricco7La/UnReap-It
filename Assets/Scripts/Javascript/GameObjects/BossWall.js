function BossWall( _game, _x, _y, _w, _h, _type)
{
    ...
    {
        case 'CornerDL':
            _self.body.setRectangle(12, 32, -7, 0);
            break;
        case 'CornerDR':
            _self.body.setRectangle(12, 32, 8, 0);
            break;
        case 'CornerUL':
            _self.body.setRectangle(12, 64, -7, 0);
            break;
        case 'CornerUR':
            _self.body.setRectangle(12, 64, 8, 0);
            break;
        case 'Down':
            _self.body.setRectangle(32, 12, 0, 10);
            break;
        case 'Left':
            _self.body.setRectangle(12, 32, -7, 0);
            break;
